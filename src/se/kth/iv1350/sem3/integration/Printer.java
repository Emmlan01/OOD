...
import se.kth.iv1350.sem3.model.SaleItems;
 ...
 public class Printer {
     ...
     public void printReceipt() {
        ...
        if (sale.getCustomerDiscountRate() > 0 || sale.getTotalCostDiscountRate() > 0 || sale.getItemDiscountAmount() > 0) {
            System.out.println("Discount(s):");
            if (sale.getCustomerDiscountRate() > 0) {
                System.out.println(" - Customer discount: " + (int)(sale.getCustomerDiscountRate() * 100) + "%");
            }
            if (sale.getTotalCostDiscountRate() > 0) {
                System.out.println(" - Total cost discount: " + (int)(sale.getTotalCostDiscountRate() * 100) + "%");
            }
            if (sale.getItemDiscountAmount() > 0) {
                System.out.println(" - Item discount: " + String.format("%.2f", sale.getItemDiscountAmount()) + " SEK");
            }
            System.out.println("Total discount applied: " + String.format("%.2f", sale.getTotalDiscountAmount()) + " SEK");
            System.out.println();
        }
