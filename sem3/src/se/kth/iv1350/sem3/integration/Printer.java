...
public class Printer {
    ...
    public void printReceipt() {
        ...
        if (sale.getCustomerDiscountRate() > 0 || sale.getTotalCostDiscountRate() > 0
                || sale.getItemDiscountAmount() > 0) {
            ...
            System.out.println(
                    "Total discount applied: " + String.format("%.2f", sale.getTotalDiscountAmount()) + " SEK");
            System.out.println();
        }
